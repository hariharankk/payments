...
import 'package:payment/widgets/Opening_Button.dart';
import 'package:payment/widgets/dialog box.dart';
...
class OpeningPage extends StatefulWidget {
  ...
  OpeningPage({required this.logoutCallback});
...
class _OpeningPageState extends State<OpeningPage> {
  ...
  void initState() {
    super.initState();
    database.employee_getdata().then((data){
      setState(() {
  ...
  Future<void> image_capture () async{
    ...
    String img = await imagestorage.uploadFile(image!, userBloc.getUserObject().user);
    if (img == null || img == "") {
      await showDialog(
          context: context,
  ...
  Future<void> image_approval () async{
    ...
    if(status == true) {
      ...
      await imagestorage.delete(userBloc.getUserObject().user);
